...
surrogate="https://github.com/timrdf/csv2rdf4lod-automation/wiki/CSV2RDF4LOD_BASE_URI#" # Came from $CSV2RDF4LOD_BASE_URI when cr-create-conversion-trigger.sh created this script.
sourceID="data-melagrid-org"               # Came from directory name ../../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetID="drugbank"             # Came from directory name ../../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions)
datasetVersion="2013-Jul-22"        # DEPRECATED
versionID="2013-Jul-22"             # Came from directory name ../ (see https://github.com/timrdf/csv2rdf4lod-automation/wiki/Directory-Conventions) renaming datasetVersion (deprecating datasetVersion)
...
java -Xmx2g -jar $CSV2RDF4LOD_HOME/lib/saxonb9-1-0-8j.jar -o:automatic/$datafile.trig -xsl:../manual/drugbank.xsl -s:$data
